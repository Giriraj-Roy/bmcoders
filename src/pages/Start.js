import { ImageBackground, Pressable, SafeAreaView, StatusBar, StyleSheet, View } from 'react-native'
    ...
    <SafeAreaView style={{flex:1, backgroundColor: Colors.lighter}}>
      <StatusBar backgroundColor="transparent" translucent={true} barStyle="dark-content" />
        ...
        <View style={{width: "100%", alignItems: "center", backgroundColor: "white"}}>
            ...
            <View height={"15%"} />
            <Button onPress={()=>navigation.navigate("SignUp")} title={"Let's Start"} textStyle={{}}/>
